...
#define SI4710_STATUS_ERR 0x40     ///< bit position of ERR flag in status byte
#define SI4710_STATUS_RDSINT 0x04  ///< bit position of RDSINT flag in status byte
#define SI4710_STATUS_ASQINT 0x02  ///< bit position of ASQINT flag in status byte
#define SI4710_STATUS_STCINT 0x01  ///< bit position of STCINT flag in status byte
